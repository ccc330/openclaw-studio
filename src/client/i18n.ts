...
const en: Dict = {
  ...
  'empty.subtitle': 'Studio scans your OpenClaw config directory and shows the agents it finds. The directory is empty (or missing). Run this command in your terminal to get started:',
  'empty.hint': 'This view refreshes automatically once an agent is registered.',
...
const zhCN: Dict = {
  ...
  'empty.title': '未发现智能体',
  'empty.subtitle': 'Studio 会扫描你的 OpenClaw 配置目录并展示其中的智能体。当前目录为空（或不存在）。在终端运行以下命令以开始：',
  'empty.hint': '注册任意智能体后，此页面会自动刷新。',
